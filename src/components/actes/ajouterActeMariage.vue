<template>
  <div class="all">
    <div class="container monda-font animate__animated animate__fadeInLeft">
      ...
      <div>
        <h2 class="monda-font">Ajouter un acte de mariage</h2>
      ...
      <form @submit.prevent="ajouterActe">
        <div style="margin-top: 20px;">
          <div style="width: 100%;">
            <div><label for="">Annee de l'acte</label></div>
        ...
        <div class="input-field">
          <div><label for="">Nom du marie</label></div>
          <input class="input" v-model="nom_marie" placeholder="Kana blaise" required>
        </div>
        <div class="input-field">
          <div><label for="">Date de naissance</label></div>
          <input type="date" class="input" v-model="date_marie" required>
        </div>
        <div class="input-field">
          <div><label for="">Nom de la mariee</label></div>
          <input class="input" v-model="nom_mariee" placeholder="Mube anne" required>
        </div>
        <div class="input-field">
          <div><label for="">Date de naissance</label></div>
          <input type="date" class="input" v-model="date_mariee" required>
        </div>
        <div class="input-field">
...
export default {
  ...
  try {
    ...
    const acte = {
      ...
      annee: this.annee,
      nom_marie: this.nom_marie,
      nom_mariee: this.nom_mariee,
      date_marie: this.date_marie,
      date_mariee: this.date_mariee,
      userId: this.userId,
    ...
    await setDoc(doc(firestore, TABLE.ACTEm, acte._id), { ...acte });
