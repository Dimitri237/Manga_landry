<template>
  <div class="all">
    <div class="container monda-font animate__animated animate__fadeInLeft">
      ...
      <div>
        <h2 class="monda-font">Ajouter un Acte de deces</h2>
      ...
      <form @submit.prevent="ajouterActe">
        <div style="margin-top: 20px;">
          <div style="width: 100%;">
            <div><label for="">Annee du deces</label></div>
        ...
        <div class="input-field">
          <div><label for="">Nom du defun</label></div>
          <input class="input" v-model="nameD" placeholder="Elianor Amanda" required>
        </div>
        <div class="input-field">
...
export default {
  ...
  try {
    ...
    await setDoc(doc(firestore, TABLE.ACTEd, acte._id), { ...acte });
